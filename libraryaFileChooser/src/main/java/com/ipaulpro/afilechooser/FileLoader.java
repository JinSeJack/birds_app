...
public class FileLoader extends AsyncTaskLoader<List<File>> {
	...
	public List<File> loadInBackground() {
        ...
        final File[] dirs = pathDir.listFiles(AFileChooserFileUtils.sDirFilter);
        if (dirs != null) {
            // Sort the folders alphabetically
            Arrays.sort(dirs, AFileChooserFileUtils.sComparator);
        ...
        final File[] files = pathDir.listFiles(AFileChooserFileUtils.sFileFilter);
        if (files != null) {
            // Sort the files alphabetically
            Arrays.sort(files, AFileChooserFileUtils.sComparator);
